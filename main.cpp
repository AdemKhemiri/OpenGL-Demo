...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("../Shaders/vertexShaderSource.glsl", "../Shaders/fragmentShaderSource.glsl");
    ...
    ourShader.use();
    glUniform1i(glGetUniformLocation(ourShader.ID, "myTexture1"), 0); // set it manually
    ourShader.setInt("myTexture2", 1); // or with shader class
    // render loop
    // -----------
